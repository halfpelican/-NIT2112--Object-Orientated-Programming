...
#    rando = Person("Tommy", "Macron")
    ...
    student3 = UndergraduateStudent(5487, "Thomas", "Saul", "Physics")
    register_student_for_unit(student3, unit1)
    unit2 = Unit("NIT2432", "Quantam Theory")
    unit3 = Unit("NIT2332", "Duck Solutions")
    unit4 = Unit("NIT2511", "Creative Writing")
    register_student_for_unit(student1, unit2)
    register_student_for_unit(student2, unit2)
    register_student_for_unit(student3, unit2)
