"""
NIT2112 Practical Test: Student Club Management System
Student Name: Benjamin Morovan
Student ID: s8014554    
Date: 02/04/2026
AI Copilot Used: Yes - Github Copilot
...
class Club(Observable):
    ...
    def __init__(
        ...
        self._executive_members: Dict[str, ExecutiveMember] = {}
    ...
    @property
    def executive_members(self) -> List[ExecutiveMember]:
