...
from exceptions import UnauthorizedApproverError, InvalidEventStateError
# =============================================================================
...
class EventState(ABC):
    ...
    @abstractmethod
    def process_approval(self, event: 'Event', approver: 'ExecutiveCommitteeMember') -> 'EventState':
        """Process approval and return new state."""
        pass
    
    @abstractmethod
    def process_rejection(self, event: 'Event', approver: 'ExecutiveCommitteeMember', reason: str) -> 'EventState':
