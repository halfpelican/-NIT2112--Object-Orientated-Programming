...
class MissionWidget(tk.Frame):
    ...
    def _refresh(self) -> None:
        ...
        progress_frame = tk.Frame(
            ...
            height=20,
            width=250,  # Fixed width for the progress bar container
            relief="sunken",
            bd=1
        )
        ...
        # Calculate fill width based on percentage (250 max width)
        fill_width = max(1, int((progress_pct / 100) * 250)) if progress_pct > 0 else 0
        ...
        # Add percentage label on top of progress bar
        pct_label = tk.Label(
            progress_frame,
            text=f"{progress_pct:.0f}%",
            bg=self._app.COLOURS["border"] if progress_pct < 50 else self._app.COLOURS["success"],
            fg=self._app.COLOURS["text"] if progress_pct < 50 else self._app.COLOURS["text_light"],
        ...
        if mission.mission_type == MissionType.KEEP_HAPPY:
            ...
            happy_animals = [
                ...
                if a.is_alive and not a.is_sick and a.species == mission.target_animal and a.happiness >= 70
            ]
            ...
            if happy_animals:
                ...
                species_display_map = {
                    ...
                    "TasmanianDevil": "Tasmanian Devils",
                    "Echidna": "Echidnas"
                }
