...
from ..models.animals.mammals import (
    Koala, Kangaroo, Wombat, Platypus, TasmanianDevil, Echidna, RingtailPossum
)
from ..models.animals.birds import Kookaburra, Emu, WedgeTailedEagle
from ..models.animals.reptiles import (
    BlueTonguedSkink,
    CarpetPython,
    EasternBrownSnake,
    SaltwaterCroc,
...
class AnimalFactory:
    ...
    _animal_types: Dict[str, Type[Animal]] = {
        ...
        "echidna": Echidna,
        "ringtail_possum": RingtailPossum,
        "ringtailpossum": RingtailPossum,  # Alternative spelling
        ...
        "goanna": Goanna,
        "carpet_python": CarpetPython,
        "carpetpython": CarpetPython,  # Alternative spelling
        "eastern_brown_snake": EasternBrownSnake,
        "easternbrownsnake": EasternBrownSnake,  # Alternative spelling
        "blue_tongued_skink": BlueTonguedSkink,
        "bluetonguedskink": BlueTonguedSkink,  # Alternative spelling
    }
    ...
    _animal_info: Dict[str, Dict[str, Any]] = {
        ...
        "ringtail_possum": {"display_name": "Ringtail Possum", "category": "mammal", "habitat": "eucalyptus_grove", "diet": "eucalyptus", "cost": 360},
        ...
        "goanna": {"display_name": "Goanna", "category": "reptile", "habitat": "eucalyptus_grove", "diet": "meat", "cost": 520},
        "carpet_python": {"display_name": "Carpet Python", "category": "reptile", "habitat": "eucalyptus_grove", "diet": "meat", "cost": 580},
        "eastern_brown_snake": {"display_name": "Eastern Brown Snake", "category": "reptile", "habitat": "eucalyptus_grove", "diet": "meat", "cost": 640},
        "blue_tongued_skink": {"display_name": "Blue-tongued Skink", "category": "reptile", "habitat": "reptile_house", "diet": "insects", "cost": 320},
    }
    ...
    def get_available_types(cls) -> List[str]:
        ...
        return sorted(cls._animal_info.keys())
    ...
    def get_animal_info(cls, animal_type: str) -> Dict[str, Any]:
        ...
        elif normalised == "ringtailpossum":
            normalised = "ringtail_possum"
        elif normalised == "carpetpython":
            normalised = "carpet_python"
        elif normalised == "easternbrownsnake":
            normalised = "eastern_brown_snake"
        elif normalised == "bluetonguedskink":
            normalised = "blue_tongued_skink"
