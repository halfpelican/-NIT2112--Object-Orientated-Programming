...
PLACEMENT_COSTS = {
    # Enclosures (3x3 multi-tile) - Purchasable from map
...
ITEM_INFO = {
    ...
    "eucalyptus_grove": {"emoji": "🐨", "name": "Eucalyptus Grove", "size": (3, 3)},
    "outback_savanna": {"emoji": "🦘", "name": "Outback Savanna", "size": (3, 3)},
    "billabong": {"emoji": "🐊", "name": "Billabong Wetland", "size": (3, 3)},
    "rainforest_aviary": {"emoji": "🦅", "name": "Rainforest Aviary", "size": (3, 3)},
    "reptile_house": {"emoji": "🦎", "name": "Reptile House", "size": (3, 3)},
    ...
    "enclosure_koala": {"emoji": "🐨", "name": "Koala Corner", "size": (3, 3)},
    "enclosure_outback": {"emoji": "🦘", "name": "Outback Plains", "size": (3, 3)},
    "enclosure_aviary": {"emoji": "🦅", "name": "Bird Paradise", "size": (3, 3)},
    "enclosure_billabong": {"emoji": "🐊", "name": "Crocodile Creek", "size": (3, 3)},
    "enclosure_reptile": {"emoji": "🦎", "name": "Reptile Realm", "size": (3, 3)},
}
